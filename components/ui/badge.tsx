...
export const badgeSemanticStyles = {
  ...
  category: {
    ...
    temperature: `${semanticBase} border-border`,
    humidity: `${semanticBase} border-border`,
    motion: `${semanticBase} border-border`,
    water_leak: `${semanticBase} border-border`,
    contact: `${semanticBase} border-border`,
    brightness: `${semanticBase} border-border`,
    air_quality: `${semanticBase} border-border`,
